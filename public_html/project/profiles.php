...
<div class="container-fluid">
    ...
    <?php if ($isMe && $edit) : ?>
        <form method="POST" onsubmit="return validate(this);">
            ...
            <div class="mb-3"><b>Password Reset</b></div><br>
            <div class="mb-3">
                <label class="form-label" for="cp">Current Password</label><br>
                <input class="form-control" type="password" name="currentPassword" id="cp" />
            </div>
            <div class="mb-3">
                <label class="form-label" for="np">New Password</label><br>
                <input class="form-control" type="password" name="newPassword" id="np" />
            </div>
            <div class="mb-3">
                <label class="form-label" for="conp">Confirm Password</label><br>
