        ...
        <div class="collapse navbar-collapse" id="navContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <?php if (is_logged_in()) : ?>
                    ...
                    <li class="nav-item"><a class="nav-link" href="<?php echo get_url('profiles.php'); ?>">Profile</a></li>
                    ...
                    <li class="nav-item"><a class="nav-link" href="<?php echo get_url('history.php'); ?>">View History</a></li>
                ...
                <?php if (has_role("Admin")) : ?>
                    <li class="nav-item"><a class="nav-link" href="<?php echo get_url('admin/list_purchase_history.php'); ?>"> The Users History</a> </li>
